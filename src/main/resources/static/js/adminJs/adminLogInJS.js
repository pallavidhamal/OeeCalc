...
var url = "http://192.168.29.26:8081/Eci/Eci/";
var url1 = "http://192.168.29.26:8081/Eci/Eci/";
				...
				console.log("dataval dataval==url : ",url1);
				 ...
				 $.ajax({
						...
						success: function(data) {
							...
							console.log("checkLoginCredential--Information role===",data.result); 
							
							alert(data.role);
							  // if true successfule login
